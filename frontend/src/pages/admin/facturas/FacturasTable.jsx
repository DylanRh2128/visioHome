                    ...
                    <tr key={f.idPago}>
                        <td>
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <div className="d-flex flex-column">
                                    <span style={{ fontWeight: "800", color: "#1a1a1a", letterSpacing: "0.5px" }}>
                        ...
                        <td>
                            <div className="small" style={{ color: "var(--text-muted)" }}>
                                {f.propiedad ? (
                                    <div className="d-flex flex-column">
                                        <span style={{ color: "#1a1a1a", fontWeight: "600" }}>{f.propiedad.titulo}</span>
                        ...
                        <td>
                            <span style={{ fontWeight: "900", color: "#000000", fontSize: "0.95rem" }}>
                                {formatPrice(f.monto)}
                            </span>
                        </td>
                        <td>
